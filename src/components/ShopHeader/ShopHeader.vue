<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back">
        <i @click="goback" class="iconfont iconfanhui"/>
      </a>
    </nav>
    <div class="shop-content" @click="isShowTop=true">
    ...
    <div class="shop-header-discounts" @click="isShowBottom = true">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-if="isShowTop" >
        <div class="brief-modal-content">
          ...
          <div @click="isShowTop = false" class="mask-footer">
            <span class="iconfont iconclose"></span>
          </div>
        </div>
        <div @click="isShowTop = false" class="brief-modal-cover"></div>
      </div>
    </transition>
    <transition name="move">
       <div class="activity-sheet" v-if="isShowBottom">
        <div class="activity-sheet-content">
          ...
          <div class="activity-sheet-close">
            <span class="iconfont iconclose" @click="isShowBottom = false"></span>
          </div>
        </div>
        <div class="activity-sheet-cover" @click="isShowBottom = false"></div>
      </div>
    </transition>  
  </div>
</template>
